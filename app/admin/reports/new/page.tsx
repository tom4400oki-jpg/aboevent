    ...
    return (
        <div className="max-w-2xl mx-auto py-8 px-4">
            <div className="mb-8">
                ...
                <p className="text-sm text-gray-500 mt-1">イベントの様子を報告して、ギャラリーを充実させましょう</p>
            </div>
            ...
            <form action={createReport} className="space-y-8 bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
                ...
                <div className="space-y-2">
                    ...
                    <textarea
                        ...
                        required
                        rows={10}
                        placeholder="開催の様子を詳しく記入してください。この内容はブログ記事として公開され、SEOに貢献します。"
                ...
                <div className="space-y-2">
                    ...
                    <p className="text-[10px] text-gray-400">※イベントを選択すると、そのイベントの詳細画面のギャラリーに写真が表示されます。</p>
                </div>
